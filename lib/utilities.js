...
// lodash aliases
utilities.defaults = require('lodash/defaultsDeep');
utilities.includes = require('lodash/includes');
utilities.isObject = require('lodash/isObject');
utilities.isNumber = require('lodash/isNumber');
utilities.values = require('lodash/values');
utilities.merge = require('lodash/merge');
utilities.clone = require('lodash/cloneDeep');
